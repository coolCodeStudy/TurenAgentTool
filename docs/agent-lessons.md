...
- For Python-rendered Web pages with embedded JavaScript, add or run a rendered-script syntax check when changing the template; Python-side parser tests can pass while browser execution fails on escaped regex or string literals.
