...
6. The user retrieves the latest or a market/date-specific brief through the Web or command surface. The Web page can generate a recent live brief directly without requiring the user to obtain or enter a token.
