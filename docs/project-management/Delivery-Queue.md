...
| DQ-2026-06-28-005 | Weekly review generator | Acceptance Testing Agent | ready_to_dispatch | not_created | `AT-2026-06-28-001` moved to `needs_retest` after main commit `9381a1a`, full deploy run `28326950490`, and cloud force-refresh evidence `/private/tmp/weekly-review-cloud-refresh-20260622.json` | Run focused black-box retest of Weekly Review content quality/source completeness on `http://47.84.190.191:8010/weekly-review`, especially partial Yahoo index evidence, reference-only company disclosure evidence, story quality, visible source gaps, and absence of raw provider/internal copy. | Delivery Coordinator should dispatch Acceptance Testing; do not mark user acceptance accepted. |
