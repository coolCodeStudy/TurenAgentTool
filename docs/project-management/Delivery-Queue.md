...
| DQ-2026-06-28-003 | Weekly review generator | Product Agent | dispatched | pending worktree `local:9876462c-7554-4133-8445-60bf3b47d14e` | Coordinator dispatch from main commit `0e3400a`; Acceptance Queue row `AT-2026-06-28-001` | Define the minimum acceptable index context, external event/news/theme context, and source-backed overall-story bar before Engineering updates the technical plan and implements the fix. | Product Agent should update the PRD/project state with acceptance criteria, then hand off to Engineering to update `docs/techplans/weekly-review.md` before implementation. |
