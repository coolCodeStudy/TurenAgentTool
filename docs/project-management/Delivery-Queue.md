...
| DQ-2026-06-28-006 | Weekly review generator | Development Agent | returned | thread `019f0c3b-8f37-74a3-b0d9-030a69bdbacc`; branch `origin/codex/weekly-review-dated-events` | Acceptance retest `AT-2026-06-28-001` failed/major on returned branch `origin/codex/weekly-review-acceptance-retest-20260628` at `c32ba3f` | Implement dated company/macro/theme event evidence so Weekly Review can explain why the week happened, not only provide company disclosure reference/search URLs. Preserve existing Yahoo index fallback and visible source-gap semantics. | Development added a Yahoo Finance RSS dated company/theme news provider and local/live-provider verification passed. Coordinator Return Gate must inspect/integrate the pushed branch, full-deploy Weekly Review Web, force-refresh week `2026-06-22`, and only move `AT-2026-06-28-001` to `needs_retest` if cloud evidence includes dated company/theme/macro events. |
