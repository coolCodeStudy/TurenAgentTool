...
| DQ-2026-06-28-006 | Weekly review generator | Development Agent | dispatched | thread `019f0c3b-8f37-74a3-b0d9-030a69bdbacc` | Acceptance retest `AT-2026-06-28-001` failed/major on returned branch `origin/codex/weekly-review-acceptance-retest-20260628` at `c32ba3f` | Implement dated company/macro/theme event evidence so Weekly Review can explain why the week happened, not only provide company disclosure reference/search URLs. Preserve existing Yahoo index fallback and visible source-gap semantics. | Await Development/Ops return under the Coordinator Return Gate; do not redispatch Acceptance Testing until cloud evidence includes dated company/theme/macro events and `AT-2026-06-28-001` is moved back to `needs_retest`. |
