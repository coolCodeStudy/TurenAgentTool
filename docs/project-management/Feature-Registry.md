...
| Portfolio Event Sentinel | [`PRD-portfolio-event-sentinel.md`](../product/PRD-portfolio-event-sentinel.md) | ready | missing | missing | not_started | doc_reference | pending | PRD exists for portfolio-relevant external event monitoring, hypothesis verification, exposure mapping, and alert routing; technical plan and implementation are not yet created. | Create a technical plan covering exposure graph storage, source providers, scoring, DingTalk routing, weekly-review integration, and verification fixtures before implementation. |
| Command Workbench | [`PRD-command-workbench.md`](../product/PRD-command-workbench.md) | ready | missing | missing | not_started | none | pending | PRD exists; technical plan and implementation evidence are not registered. | Create a technical plan before implementation. |
