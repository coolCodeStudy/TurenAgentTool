...
| Weekly review generator | [`PRD-每周复盘.md`](../product/PRD-每周复盘.md) | ready | [`weekly-review.md`](../techplans/weekly-review.md) | partially_implemented | deployed | needs_review | pending | Core weekly review generation, persistence, command path, and web surface exist. 2026-06-28 cloud retest confirmed natural-week read/generate/force-refresh behavior and product-language degraded source statuses, but public unauthenticated `POST /api/weekly-review/save` wrote a weekly report when no token was available in the acceptance environment, and save success copy still exposes the internal table name `review_reports #...`. External index, macro, news/theme, and opportunity sources remain incomplete. | Development Agent should remove internal table-name copy; Development/Ops must require or configure weekly-review write authentication for public generate/refresh/save access, then deploy and rerun AT-2026-06-25-001. Keep missing external-source integrations as follow-up product/tech work. |
...
| Weekly review natural week and force refresh | [`PRD-weekly-review-week-scope-and-force-refresh.md`](../product/PRD-weekly-review-week-scope-and-force-refresh.md) | superseded | [`weekly-review-week-scope-force-refresh.md`](../techplans/weekly-review-week-scope-force-refresh.md) | partially_implemented | deployed | needs_review | pending | P0 natural-week Web contract is deployed and the 2026-06-28 cloud retest passed read existing, generate existing without rerun, explicit `force=true` refresh, product-language source statuses, and absence of the previous raw provider/database errors. Blockers remain: unauthenticated public save wrote a weekly report, and save success copy exposes `review_reports #...`. Token usage metadata columns exist, but provider-level token accounting and external source integrations remain follow-up scope. | Remove internal table-name copy and fix or configure weekly-review write authentication on the public cloud surface, then rerun AT-2026-06-25-001; keep P1 external data providers and token-cost views as separate follow-up work. |
