...
| Stock valuation research | [`PRD-Stock-Valuation-Research.md`](../product/PRD-Stock-Valuation-Research.md) | ready | [`stock-valuation-research.md`](../techplans/stock-valuation-research.md) | implemented | needs_deploy | test_passed | needs_reacceptance | P0, P0.1, and P0.2 were deployed, independently tested, and user accepted. P0.3 adds KR/HK valuation coverage and previously passed focused independent testing on release commit `e05e689`, but a later Frontend shell deploy replaced the shared `/command` release lineage and removed valuation/Kline actions from the live catalog. Global PM is reconciling latest `origin/main` with the accepted Frontend shell, Command Workbench access setup, Kline live provider, and Stock valuation P0.3 line. | Stock valuation Feature Coordinator should deploy the exact Global PM combined release ref through the shared Ops path, verify the complete Workbench catalog plus KR/HK/US valuation and Kline behavior, move `AT-2026-07-05-003` to `needs_retest`, and dispatch independent cloud acceptance before asking the user to reaccept P0.3. |
