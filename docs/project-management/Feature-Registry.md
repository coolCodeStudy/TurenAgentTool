...
| Position Discipline Layer | [`PRD-position-discipline-layer.md`](../product/PRD-position-discipline-layer.md) | ready | missing | missing | not_started | doc_reference | pending | PRD exists and positions the feature as an InvestmentKnowledge module, not a separate product; no technical plan or implementation exists yet. | Create a technical plan for the discipline card, review queue, portfolio-analysis integration, and weekly-review integration MVP. |
