...
- Next handoff: `blocked_with_owner`: independent acceptance returned with public/local-first pass but protected success blocked. Do not request a token value; resume only when the named secure fixture/session contract is available.
