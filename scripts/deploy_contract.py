...
PATH_RULES = (
    ...
    PathRule("*.md", DeployMode.NO_DEPLOY, (), "documentation"),
    PathRule("**/*.md", DeployMode.NO_DEPLOY, (), "documentation"),
    PathRule("docs/**", DeployMode.NO_DEPLOY, (), "documentation"),
    PathRule("tests/**", DeployMode.NO_DEPLOY, (), "tests"),
    PathRule(".github/workflows/*.yml", DeployMode.NO_DEPLOY, (), "workflow governance"),
    PathRule(".github/workflows/*.yaml", DeployMode.NO_DEPLOY, (), "workflow governance"),
...
def _is_deployment_sensitive(path: str) -> bool:
    return path.startswith(("scripts/", "deploy/", ".github/", "docker-compose", "Dockerfile"))
