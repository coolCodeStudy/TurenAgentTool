...
PATH_RULES = (
    ...
    PathRule("docs/Agent工作模式演进计划.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/MCP工具设计.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/MVP路线图.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/Ops诊断与CodexApp接入方案.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/README.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/agent-lessons.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/codex-session-workflow.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/lesson-capture-protocol.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Acceptance-Testing-Agent-Protocol.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Agent-Operating-Model.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Delivery-Coordinator-Protocol.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/PRD-Kline-Agent.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/PRD-Stock-Valuation-Research.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/PRD-command-workbench.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/PRD-weekly-review-week-scope-and-force-refresh.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/PRD-每周复盘.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Product-Agent-Working-Protocol.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Product-Strategy-and-Roadmap.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/Project-Management-Agent-Protocol.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/product/周复盘Web工作台产品文档.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-history.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Acceptance-Queue.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Agent-Operating-Model-Roadmap.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Coordinator-Context-Packet.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Delivery-Queue.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Deploy-Classification.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/Feature-Registry.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/agent-flow-eval-cases.json", DeployMode.NO_DEPLOY, (), "repository governance data"),
    PathRule("docs/project-management/prompt-templates/Acceptance-Testing.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/prompt-templates/Deploy-Conflict-Resolution.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/prompt-templates/Feature-Coordinator.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/prompt-templates/Frontend-Review.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/project-management/prompt-templates/Release-Integration.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/superpowers/plans/2026-07-10-deploy-flow-optimization.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/superpowers/specs/2026-07-10-deploy-flow-optimization-design.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/cloud-pull-deploy-plan.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/command-workbench.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/control-plane-and-throughput-plan.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/kline-agent-v1.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/task2-cloud-worker-execution-location.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/task3-research-display-decision-card.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/weekly-review-web-workbench.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/weekly-review-week-scope-force-refresh.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/techplans/weekly-review.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/个股录入工作流.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/个股研究草稿协议.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/富途持仓接入.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/当前工程状态.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/技术方案.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/数据模型.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/消息入口设计.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
    PathRule("docs/阿里云最小部署清单.md", DeployMode.NO_DEPLOY, (), "repository documentation"),
