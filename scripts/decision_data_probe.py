...
def main() -> None:
    parser = argparse.ArgumentParser(description="Probe decision-data provider coverage for a stock.")
    ...
    print(render_probe_result(probe_decision_data_coverage(symbol=args.symbol, market=args.market)))
